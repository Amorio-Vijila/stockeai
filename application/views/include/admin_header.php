...
$(document).ready(function() {
    ...
    data[csrfName] = csrfHash;
    $.ajax({
        url: '<?php echo base_url(); ?>Cweb_setting/setting_for_notification',
        method: "POST",
        data: data,
        dataType: "json",
        success: function(response) {
            console.log("Response from setting_for_notification:", response);
            if (response) {
                console.log("Available condition met");
                                ...
                                <div class="menuCol col-xl-3 col-lg-3 col-md-12">
                                    <ul class="dropdown-submenu">
                                        ...
                                        <li><a href="<?php echo base_url('Cweb_setting/invoice_template') ?>"><i
                                                    class="ti-settings"></i></i>&nbsp;&nbsp;Sales Invoice </a></li>
                                        <li><a href="<?php echo base_url('Cweb_setting/invoice_design') ?>"><i
                                                    class="ti-settings"></i></i>&nbsp;&nbsp;Invoice Design </a></li>
                                        <li><a href="<?php echo base_url('Cweb_setting/invoice_content') ?>"><i
                                                    class="ti-settings"></i></i>&nbsp;&nbsp;Invoice Content </a>
                                        </li>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview  <?php echo ($this->uri->segment(1) == 'Permission') ? 'active' : ''; ?>">
                ...
                <ul class="treeview-menu">
                    <li class="treeview  "><a
                            href="<?php echo base_url(); ?>/Permission/super_role_list"><?php echo ('Role List');  ?></a>
                    </li>
                    <li class="treeview  "><a
                            href="<?php echo base_url(); ?>/Permission/company_role_index"><?php echo ("Admin Assign Role");  ?></a>
                    </li>
                </ul>
            </li>
        </ul>
      ...
      ?>
        <ul class="sidebar-menu">
            ...
            <li class="treeview  <?php echo ($this->uri->segment(1) == 'Cinvoice') ? 'active' : ''; ?>">
                ...
                <ul class="treeview-menu">
                    <li class="treeview  <?php echo ($this->uri->segment(2) == 'manage_invoice') ? 'active' : ''; ?>"><a
                            href="<?php echo base_url(); ?>/Cinvoice/manage_invoice"><?php echo display('Create Invoice'); ?></a>
                    </li>
                    <li
                        class="treeview  <?php echo ($this->uri->segment(2) == 'manage_profarma_invoice') ? 'active' : ''; ?>">
                        <a
                            href="<?php echo base_url(); ?>/Cinvoice/manage_profarma_invoice"><?php echo display('Quote'); ?></a>
                    </li>
                    <li
                        class="treeview  <?php echo ($this->uri->segment(2) == 'manage_ocean_export_tracking') ? 'active' : ''; ?>">
                        <a
                            href="<?php echo base_url(); ?>/Cinvoice/manage_ocean_export_tracking"><?php echo display('Ocean Export Tracking'); ?></a>
                    </li>
                    <li class="treeview  <?php echo ($this->uri->segment(2) == 'manage_trucking') ? 'active' : ''; ?>">
                        <a
                            href="<?php echo base_url(); ?>/Cinvoice/manage_trucking"><?php echo display('Road Transport'); ?></a>
                    </li>
                </ul>
            </li>
            <?php
            ...
            <li class="treeview  <?php echo ($this->uri->segment(1) == 'Cpurchase') ? 'active' : ''; ?>">
                ...
                <ul class="treeview-menu">
                    <li class="treeview  <?php echo ($this->uri->segment(2) == 'manage_purchase') ? 'active' : ''; ?>">
                        <a
                            href="<?php echo base_url(); ?>/Cpurchase/manage_purchase"><?php echo display('Create Expense'); ?></a>
                    </li>
                    <li
                        class="treeview  <?php echo ($this->uri->segment(2) == 'manage_purchase_order') ? 'active' : ''; ?>">
                        <a
                            href="<?php echo base_url(); ?>/Cpurchase/manage_purchase_order"><?php echo display('Purchase Order'); ?></a>
                    </li>
                    <li
                        class="treeview  <?php echo ($this->uri->segment(2) == 'manage_ocean_import_tracking') ? 'active' : ''; ?>">
                        <a
                            href="<?php echo base_url(); ?>/Ccpurchase/manage_ocean_import_tracking"><?php echo display('Ocean Import Tracking'); ?></a>
                    </li>
                    <li class="treeview  <?php echo ($this->uri->segment(2) == 'manage_trucking') ? 'active' : ''; ?>">
                        <a
                            href="<?php echo base_url(); ?>/Ccpurchase/manage_trucking"><?php echo display('Road Transport'); ?></a>
                    </li>
                </ul>
            </li>
            <?php
            ...
            <li class="treeview  <?php echo ($this->uri->segment(1) == 'accounts') ? 'active' : ''; ?>">
                ...
                <ul class="treeview-menu">
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li class="treeview">
                                <a href="<?php echo base_url('accounts/treeview_form') ?>"><?php echo 'Account List  '; ?>
                                </a>
                            </li>
                            <li class="treeview">
                                <a
                                    href="<?php echo base_url('accounts/balance_sheet_compare') ?>"><?php echo 'Balance Sheet Comparison '; ?></a>
                            </li>
                            <li class="treeview">
                                <a
                                    href="<?php echo base_url('accounts/balance_sheet') ?>"><?php echo 'Balance Sheet'; ?></a>
                            </li>
                            <li class="treeview">
                                <a
                                    href="<?php echo base_url('accounts/transaction_split') ?>"><?php echo 'Transaction List with Splits'; ?></a>
                            </li>
                            <li class="treeview">
                                <a
                                    href="<?php echo base_url('accounts/cash_flow_report') ?>"><?php echo 'Statement of Cash Flows'; ?></a>
                            </li>
                            <li class="treeview">
                                <a
                                    href="<?php echo base_url(); ?>/accounts/trail_balance_reports"><?php echo display('trial_balance');  ?></a>
                            </li>
                            <li class="treeview">
                                <a
                                    href="<?php echo base_url('accounts/transcation_details') ?>"><?php echo 'Transaction Details'; ?></a>
                            </li>
                            <li class="treeview">
                                <a
                                    href="<?php echo base_url('accounts/generalLedger') ?>"><?php echo 'General Ledger'; ?></a>
                            </li>
                            <li class="treeview">
                            ...
                            <li class="treeview">
                                <a
                                    href="<?php echo base_url('accounts/profit_loss') ?>"><?php echo 'Profit Loss'; ?></a>
                            </li>
                            <li class="treeview">
                                <a
                                    href="<?php echo base_url('accounts/profit_loss_comparison') ?>"><?php echo 'Profit Loss Comparison'; ?></a>
                            </li>
                        </ul>
                    </li>
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="treeview">
                                <a
                                    href="<?php echo base_url('Cinvoice/customer_report_data') ?>"><?php echo 'Sales By Customer'; ?></a>
                            </li>
                            <li class="treeview">
                                <a
                                    href="<?php echo base_url('Ccustomer/transaction_list') ?>"><?php echo 'Transaction By Customer'; ?></a>
                            </li>
                        </ul>
                    </li>
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="treeview">
                                <a
                                    href="<?php echo base_url('Cinvoice/vendor_report_data') ?>"><?php echo 'Purchase By Vendor'; ?></a>
                            </li>
                            <li class="treeview">
                                <a
                                    href="<?php echo base_url('Csupplier/transaction_list') ?>"><?php echo 'Transaction to Vendor'; ?></a>
                            </li>
                        </ul>
                    </li>
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="treeview">
                                <a
                                    href="<?php echo base_url('Cproduct/product_info_stock') ?>"><?php echo 'Product Stock'; ?></a>
                            </li>
                        </ul>
                    </li>
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="treeview">
                                <a
                                    href="<?php echo base_url('Cinvoice/expense_tax') ?>"><?php echo 'Taxable Expense  Detail'; ?></a>
                            </li>
                        </ul>
                    </li>
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="treeview">
                                <a
                                    href="<?php echo base_url('Accounts/account_receivable_ageing_summary') ?>"><?php echo 'Receivables Ageing Summary'; ?></a>
                            </li>
                            <li class="treeview">
                                <a
                                    href="<?php echo base_url('Accounts/open_invoices') ?>"><?php echo 'Unpaid Invoices'; ?></a>
                            </li>
                        </ul>
                    </li>
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="treeview">
                                <a
                                    href="<?php echo base_url('Accounts/account_payable_ageing_summary') ?>"><?php echo 'Payables Ageing Summary'; ?></a>
                            </li>
                            <li class="treeview">
                                <a
                                    href="<?php echo base_url('Accounts/open_invoices_debt') ?>"><?php echo 'Unpaid Bills'; ?></a>
                            </li>
                        </ul>
                    </li>
                    <li class="treeview"><a
                            href="<?php echo base_url(); ?>/Csettings/bank_ledgers"><?php echo 'Bank Ledger'; ?></a>
                    </li>
                    <li class="treeview"><a
                            href="<?php echo base_url('accounts/salesReport') ?>"><?php echo 'Sales Report'; ?> </a>
                    </li>
                    <li class="treeview"><a
                            href="<?php echo base_url('accounts/expenseReport') ?>"><?php echo 'Expense Report'; ?>
                        </a>
                    </li>
                    <li class="treeview"><a
                            href="<?php echo base_url(); ?>/Admin_dashboard/closing"><?php echo display('closing'); ?></a>
                    </li>
                    <li class="treeview"><a
                            href="<?php echo base_url(); ?>/Admin_dashboard/closing_report"><?php echo display('closing_report'); ?></a>
                    </li>
                    <li class="treeview"><a
                            href="<?php echo base_url(); ?>/Admin_dashboard/all_report"><?php echo  display('todays_report');  ?></a>
                    </li>
                </ul>
            </li>
            <?php
            ...
            <li class="treeview <?php echo ($this->uri->segment(1) == 'Chrm') ? 'active' : ''; ?>">
                ...
                <ul class="treeview-menu">
                    <li class="treeview  "><a
                            href="<?php echo base_url(); ?>/Chrm/manage_employee"><?php echo display('Employee Info (W4 form)'); ?></a>
                    </li>
                    <li class="treeview <?php echo ($this->uri->segment(2) == 'manage_timesheet') ? 'active' : ''; ?>">
                        <a
                            href="<?php echo base_url(); ?>/Chrm/manage_timesheet"><?php echo display('Time sheet'); ?></a>
                    </li>
                    <li class="treeview <?php echo ($this->uri->segment(2) == 'pay_slip_list') ? 'active' : ''; ?>">
                        <a
                            href="<?php echo base_url(); ?>/Chrm/pay_slip_list"><?php echo display('Pay slip / Checks per user'); ?></a>
                    </li>
                    <li
                        class="treeview <?php echo ($this->uri->segment(2) == 'generateAgentcheck') ? 'active' : ''; ?>">
                        <a
                            href="<?php echo base_url(); ?>/Chrm/generateAgentcheck"><?php echo 'Agent Check Generation'; ?></a>
                    </li>
                    <li class="treeview <?php echo ($this->uri->segment(2) == 'agent_check') ? 'active' : ''; ?>"><a
                            href="<?php echo base_url(); ?>/Chrm/agent_check"><?php echo ('Manage Agent'); ?></a>
                    </li>
                    <li class="treeview <?php echo ($this->uri->segment(2) == 'payroll_setting') ? 'active' : ''; ?>">
                        <a
                            href="<?php echo base_url(); ?>/Chrm/payroll_setting"><?php echo display('Payroll settings'); ?></a>
                    </li>
               ...
               foreach ($this->session->userdata('perm_data') as $test) {
                ...
                <li class="treeview <?php echo ($this->uri->segment(1) == 'Admin_dashboard') ? 'active' : ''; ?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="treeview  "><a
                                href="<?php echo base_url(); ?>/Admin_dashboard/todays_customer_receipt"><?php echo  display('todays_customer_receipt');  ?></a>
                        </li>
                        <li class="treeview  "><a
                                href="<?php echo base_url(); ?>/Admin_dashboard/todays_sales_report"><?php echo display('sales_report'); ?></a>
                        </li>
                        <li class="treeview  "><a
                                href="<?php echo base_url(); ?>/Admin_dashboard/user_sales_report"><?php echo display('user_wise_sales_report'); ?></a>
                        </li>
                        <li class="treeview  "><a
                                href="<?php echo base_url(); ?>/Admin_dashboard/retrieve_dateWise_DueReports"><?php echo  display('due_report');  ?></a>
                        </li>
                        <li class="treeview  "><a
                                href="<?php echo base_url(); ?>/Admin_dashboard/retrieve_dateWise_Shippingcost"><?php echo  display('shipping_cost_report');  ?></a>
                        </li>
                        <li><a
                                href="<?php echo base_url(); ?>/Admin_dashboard/todays_purchase_report"><?php echo  display('purchase_report');  ?></a>
                        </li>
                        <li class="treeview  "><a
                                href="<?php echo base_url(); ?>/Admin_dashboard/purchase_report_category_wise"><?php echo  display('purchase_report_category_wise');  ?></a>
                        </li>
                        <li class="treeview  "><a
                                href="<?php echo base_url(); ?>/Admin_dashboard/product_sales_reports_date_wise"><?php echo  display('sales_report_product_wise');  ?></a>
                        </li>
                        <li class="treeview  "><a
                                href="<?php echo base_url(); ?>/Admin_dashboard/sales_report_category_wise"><?php echo  display('sales_report_category_wise');  ?></a>
                        </li>
                        <li class="treeview  "><a
                                href="<?php echo base_url(); ?>/Admin_dashboard/sales_return"><?php echo  display('invoice_return');  ?></a>
                        </li>
                        <li class="treeview  "><a
                                href="<?php echo base_url(); ?>/Admin_dashboard/supplier_return"><?php echo display('supplier_return'); ?></a>
                        </li>
                        <li class="treeview  "><a
                                href="<?php echo base_url(); ?>/Admin_dashboard/retrieve_dateWise_tax"><?php echo display('tax_report'); ?></a>
                        </li>
                        <li class="treeview  "><a
                                href="<?php echo base_url(); ?>/Admin_dashboard/total_profit_report"><?php echo display('profit_report'); ?></a>
                        </li>
                        <li class="treeview  "><a
                                href="<?php echo base_url(); ?>/Creport/product_stock"><?php echo display('stock_report_product_wise'); ?></a>
                        </li>
                    </ul>
                </li>
                <?php
               ...
               foreach ($this->session->userdata('perm_data') as $test) {
                ...
                <li class="treeview <?php echo ($this->uri->segment(1) == 'accounts') ? 'active' : ''; ?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="treeview  "><a
                                href="<?php echo base_url(); ?>/accounts/journal_voucher"><?php echo display('journal_voucher'); ?></a>
                        </li>
                        <li class="treeview  ">
                            <a href=""><?php echo display('report'); ?> <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
               ...
               foreach ($this->session->userdata('perm_data') as $test) {
                ...
                <li class="treeview <?php echo ($this->uri->segment(1) == 'Csettings') ? 'active' : ''; ?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="treeview  "><a
                                href="<?php echo base_url(); ?>/Csettings/bank_ledger"><?php echo display('bank_ledger'); ?></a>
                        </li>
                    </ul>
                </li>
                <?php
               ...
               foreach ($this->session->userdata('perm_data') as $test) {
                ...
                <li class="treeview <?php echo ($this->uri->segment(1) == 'Chrm') ? 'active' : ''; ?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="treeview  "><a
                                href="<?php echo base_url(); ?>/Chrm/expense_list"><?php echo display("expense"); ?></a>
                        </li>
                    </ul>
                </li>
                <?php
