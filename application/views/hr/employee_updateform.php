                  ...
                  <div class="row">
                     ...
                     <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-8">
                           <input class="form-control" name ="phone" id="mobile" type="tel"  style="border: 2px solid #d7d4d6;" required=""   placeholder="(XXX) XXX-XXXX"   value="<?php echo html_escape($employee_data[0]['phone'])?>"   min="0" tabindex="3" required=""  oninput="formatPhoneNumber(this)" >
                           </div>
                        </div>
                        <div class="form-group row">
                           ...
                           <label for="ETA" class="col-sm-4 col-form-label"><?php echo display('Attachments ') ?></label>
                              <div class="col-sm-6">
                                 <p>
                                    ...
                                    <input type="file" name="files[]" class="upload" id="attachment"   value="<?php echo html_escape($employee_data[0]['files']);?>"  style="visibility: hidden; position: absolute;" multiple accept=".pdf, .docx, .txt" />
